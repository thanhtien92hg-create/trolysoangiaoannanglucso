...
<div class="main-header">
    ...
    <p>Tác giả: Vương Thanh Tiện - Trường Tiểu học Quyết Tiến - ĐT: 0967 398178</p>
</div>
""", unsafe_allow_html=True)
...
# --- CHÂN TRANG ---
st.markdown("---")
st.markdown("<div style='text-align: center; color: #666;'>© 2025 - Vương Thanh Tiện - Trường Tiểu học Quyết Tiến - ĐT: 0967 398178</div>", unsafe_allow_html=True)
